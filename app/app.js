...
marniEngineeringApp.config(function($stateProvider, $urlRouterProvider, $translateProvider) {
    ...
    $translateProvider
        .translations('en', {
            ...
            ABOUT_TEAM: 'The Company team consists of highly qualified electrical engineers with over 20 years of experience in designing, manufacturing, modernization and technical services of metal cutting machines using lathes in Mashstroу JSC:',
            ...
            PRODUCT_INFO: ' The company manufactures electronic devices for emergency stop of asynchronous motors with nominal supply up to 3x415V and nominal power - up to 22kW.',
            ...
            CONTACTS_PHONE_TITLE: 'Phone numbers',
